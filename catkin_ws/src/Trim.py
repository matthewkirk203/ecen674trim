...
class Trim():
    ...
    def getAileronAndRudder(self,beta):
        # The code is broken down into several steps to increase readability
    ...
    def get_f_x_u(self,alpha,beta,phi):
        ...
        pedot = (cos_theta*cos_psi*self.u + (sin_phi*sin_theta*sin_psi +
    ...
    def getJ(self,alpha,beta,phi):
        ...
        self.get_f_x_u()
        return np.norm(self.xdotTrim - self.fx)**2
