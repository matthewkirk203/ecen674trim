...
kmotor  = 80            # Maximum exit airspeed that leaves the propellers
k_T_p   = 0             # Coefficient used to determine the torque that is opposite to the direction of the propeller rotation
k_Omega = 0             # Coefficient used to determine the torque that is opposite to the direction of the propeller rotation. Relates
...
# ell - roll, n- yaw 
C_Y_0         = 0        # Value of the lateral force coefficient, C_Y, when beta = p = r = delta_a = 0
C_ell_0       = 0        # Value of the lateral force coefficient, C_ell, when beta = p = r = delta_a = 0
C_n_0         = 0        # Value of the lateral force coefficient, C_n, when beta = p = r = delta_a = 0
C_Y_beta      = -0.98
